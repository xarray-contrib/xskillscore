...
def test_correlation_broadcasts(a, b, metrics):
    ...
    if (
        ...
        with pytest.raises(ValueError, match="ndex"):  # match "indexes along dimension" and "cannot align objects with join='exact' where index/labels/sizes are not equal along these coordinates (dimensions)"
